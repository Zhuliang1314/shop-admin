        ...
        <el-form :model="form" ref="form" label-width="160px">
           <el-tabs v-model="activeName">
               ...
               <el-form-item label="密码最小长度">
                <el-input v-model="form.password_min" placeholder="密码最小长度" 
                 size="normal" style="width:30%" type="number" ></el-input>
              </el-form-item>  
               <el-form-item label="强制密码复杂度">
                   ...
                   <el-form-item label="默认上传方式">
                    <el-radio-group v-model="form.upload_method">
                     ...
                     <el-form-item label="Bucket">
                        ...
                        size="normal" style="width:30%"  ></el-input>
                    </el-form-item>  
                    ...
                    <el-form-item label="空间域名">
                        <el-input v-model="form.upload_config.http" placeholder="空间域名" 
                        size="normal" style="width:30%"  ></el-input>
                ...
                <el-tab-pane label="Api安全" name="third">
                  <el-form-item label="是否开启Api安全">
                    ...
                    <small class=" text-gray-500 flex mt-1">增值电信业务经营许可证：
                         合字B2-20090007京ICP备10036305号-7京公网安备11010802022657号隐私与 Cookie法律声明广告关于我们的广告帮助反馈
                        </small>
                   </el-form-item>
                    <el-form-item label="秘钥">
                        <el-input v-model="form.upload_config.api_secret" placeholder="秘钥" style="width:30%"  ></el-input>
                        <small class=" text-gray-500 flex mt-1">增值电信业务经营许可证：
                         合字B2-20090007京ICP备10036305号-7京公网安备11010802022657号隐私与 Cookie法律声明广告关于我们的广告帮助反馈
                        </small>
                    </el-form-item>  
           ...
           <el-form-item type="primary" size="default" @click="submit">
               保存
           </el-form-item>
